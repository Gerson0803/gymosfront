  ...
  if (!member) {
    return (
      <section className="rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-sm">
        ...
        <p className="mt-2 text-sm text-slate-500">Unable to edit this record because it does not exist.</p>
        <Link
          href="/clients"
  ...
  return (
    <div className="space-y-4">
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <p className="mt-1 text-sm text-slate-500">Update profile details and attendance records.</p>
      </section>
